...
\TODO{Add email addresses for everyone? For students: 
jburket@cmu.edu
...
\monthandyear{Month and Year (date added at time of publication)}
\reportnumber{CMU/SEI-2014-TR-XXX (REPORT NUMBERS ADDED AT TIME OF PUBLICATION)}
...
{\fontfamily{cmr}\selectfont
	...
	\bibliography{content/bibliography} % File type ".bib" is assumed
}
