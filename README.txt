...
needs to be modified and compiled to produce the desired PDF output formatting.
	...
	identity-report.tex		The main TR/TR Draft/TN document file.

		"Use the commented out code at the top of this file to choode between
		TR, TR Draft, and TN document syles and whether or not to display
...
Other Files:
	...
	identity-report.ist		Index style file for the TR/TR Draft/TN document index

	SEIreport.sty			This is the master style file that sefines the
					styling rules for the master document tex files.

	identity-report.pdf		Output PDF for the TR/TR Draft/TN document.
