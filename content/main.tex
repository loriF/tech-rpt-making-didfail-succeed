...
The main DidFail webpage is \ttt{\url{http://www.cert.org/secure-coding/tools/didfail.cfm}}.  The version of DidFail and the test apps described in this report are also directly available on the Carnegie Mellon University website: 
\\ \ttt{\url{https://www.cs.cmu.edu/~wklieber/didfail/install-latest.html}}.
