...
%% Begin commented out region from student paper
%% \usepackage{cite}
...
%% End commented out region from student paper
...
% make the title area
\maketitle
\TODO{Add email addresses for everyone? For students: jburket@cmu.edu   jlim2@andrew.cmu.edu  wshen1@andrew.cmu.edu  wsnavely@andrew.cmu.edu}
