...
These additional flows from the Cartesian product calculation are added to the set of flows before DidFail performs its usual flow matching process (which is described in detail in \cite{didfail}). \TODO{It's not before matching!}
